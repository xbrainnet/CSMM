...
class SANN_eye(nn.Module):

    def __init__(self):
        super(SANN_eye, self).__init__()
        self.shallow = nn.Sequential()
        self.shallow.add_module('s_fc1', nn.Linear(31, 128))
        self.shallow.add_module('s_bn1', nn.BatchNorm1d(128))
        self.shallow.add_module('s_relu1', nn.ReLU())
        self.shallow.add_module('s_drop1', nn.Dropout())
        self.shallow.add_module('s_fc2', nn.Linear(128, 256))
        self.shallow.add_module('s_bn2', nn.BatchNorm1d(256))
        self.shallow.add_module('s_relu2', nn.ReLU())


        self.deep = nn.Sequential()
        self.deep.add_module('de_fc1', nn.Linear(256, 128))
        ...
        self.class_classifier.add_module('c_fc1', nn.Linear(128, 4))
        self.class_classifier.add_module('c_softmax', nn.LogSoftmax(dim=1))


        self.domain_classifier = nn.Sequential()
        self.domain_classifier.add_module('d_fc1', nn.Linear(256, 32))
